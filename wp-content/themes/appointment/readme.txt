...
Appointment WordPress Theme, Copyright (C) 2013-2022, priyanshumittal
Appointment is distributed under the terms of the GNU GPL

== Changelog ==

@version 3.2.7
1. Fixed service section clearfix issue.
@version 3.2.6
1. Fixed escaping issue in customizer notice.
@Version 3.2.5
1. Fixed the issues with PHP 8.
@Version 3.2.4
1. Fixed site title and menu style issues.
2. Updated some strings.
@Version 3.2.3
1. Fixed theme check warning.
2. Fixed escaping and empty markup issues.
3. Removed unnecessary code.
@Version 3.2.2
1. Added recommended plugins for starter sites.
2. Removed some code for import demo data.
@Version 3.2.1
1. Fixed widget design issues with WordPress 5.8.
@Version 3.2
1. Added Demo Import feature with Elementor Starter Sites.
@Version 3.1
1. Added Elementor template with slider.
@Version 3.0
1. Added custom color & typography features.
2. Changed typography of the theme.
@Version 2.9
1. Removed the Google plus social icon and fixed the breadcrumb issue in responsive view.
2. Fixed slider responsive issue.
@Version 2.8.9
...
1. String Update.
@Version 2.8.5
1. Add Seo Optimized Images plugin as recommend.
@Version 2.8.4
...
* Image used for the One Click Demo Import
License: Under the terms of the GNU General Public License
Source: https://wordpress.org/plugins/one-click-demo-import/

* Image used for the Elementor
License: Under the terms of the GNU General Public License
Source: https://wordpress.org/plugins/elementor/

* Images on /images and /admin/assets/img folder
Copyright (C) 2013-2022, Webriti and available as [GPLv2](https://www.gnu.org/licenses/gpl-2.0.html)
