...
Appointment Dark WordPress Theme is a child theme of Appointment Theme, Copyright (C) 2020-2022, priyanshumittal
Appointment Dark WordPress Theme is distributed under the terms of the GNU GPL
...
@Version 1.2.2
1. Updated some strings.

@Version 1.2.1
1. Fixed theme check warnings.
2. Fixed widget design issues with WordPress 5.8.
...
@Version 0.6
1. Updated description in style.css and readme file.

@Version 0.5
1. Removed translation function from lorum ipsum dummy content.

@Version 0.4
1. Fixed menu and style issues.

@Version 0.3
1. Changed theme URI in style.css.
...
Copyright (C) 2020-2022, Webriti and available as [GPLv2](https://www.gnu.org/licenses/gpl-2.0.html)
